...
main(int argc, char *argv[])
{
	...
	xe = xmld_add_tag(&xl, top_xe, "level1a");
	xmlsd_set_attr(xe, "l1a_attr", "l1a");
	xe = xmld_add_tag(&xl, top_xe, "level1b");
	xmlsd_set_attr(xe, "l1b_attr", "l1b");
	xe = xmld_add_tag(&xl, top_xe, "level1c");
	xmlsd_set_attr(xe, "l1c_attr", "l1c");
	xmlsd_set_value(xe, "something");
	xe1 = xmld_add_tag(&xl, top_xe, "level1d");
	xmlsd_set_attr(xe1, "l1d_attr", "l1d");
	xe = xmld_add_tag(&xl, xe1, "level2");
	...
	xe = xmld_add_tag(&xl, xe, "level3");
	xe = xmld_add_tag(&xl, xe, "level4");
	xe = xmld_add_tag(&xl, xe, "level5");
	xe = xmld_add_tag(&xl, xe, "level6");
	xe = xmld_add_tag(&xl, xe, "level7");
	xe = xmld_add_tag(&xl, xe, "level8");
	xe = xmld_add_tag(&xl, xe, "level9");
	xe = xmld_add_tag(&xl, xe, "level10");
	xe = xmld_add_tag(&xl, xe, "level11");
	xmlsd_set_value(xe, "foo");
	xe = xmld_add_tag(&xl, xe1, "level2");
	xmlsd_set_attr(xe, "name", "c");
	xmlsd_set_attr(xe, "l2c_attr0", "0");
	xe = xmld_add_tag(&xl, xe, "level3b");
